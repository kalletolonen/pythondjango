...
So, then it was time to do some actual development. First I made a simple model with 1 field, added that to admin.py and added my app to settings.py.
...
I was still getting the same error, eventhought I had edited the files. That suggested to me that I had edited the wrong file. Looking at the error message more closely told me that I had forgotten to change the name of my class in admin.py.
...
I started over. First I made  my urls.py.
...
I added some iteration for my template.
